...
def small_talk(request, responder):
    responses = ['Я би з задоволенням з вами поспілкувалася, але можу допомогти лише з послугами компанії "Смідл."',
                 'Я можу допомогти вам з такими питаннями:\n1) перевірка балансу\n2) виклик майстра додому\n3) зміна тарифного плану\n4) опис вашого діючого тарифного плану\n4) підключення послуги "Кредит довіри"\n5) перевірка проблем з роботою інтернету.'
